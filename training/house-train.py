...
data_dir = 'data/household-items'
image_exts = ['jpeg', 'jpg', 'bmp', 'png']

data = tf.keras.utils.image_dataset_from_directory('data/household-items')
...
model_path = 'models/household_class.h5'
...
# Test individual house image
test_image_path = ''  # Use real path
...
if img is not None:
    ...
    plt.title(f"predicted household item: {class_names[predicted_idx]} ({confidence*100:.1f}%)")
    plt.axis('off')
    plt.show()
