...
data = tf.keras.utils.image_dataset_from_directory('data/money')
...
model_path = 'models/money_class.h5'
...
# Test individual wallet item image
...
if img is not None:
    ...
    plt.title(f"predicted wallet item: {class_names[predicted_idx]} ({confidence*100:.1f}%)")
    plt.axis('off')
    plt.show()
