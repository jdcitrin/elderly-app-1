...
data_dir = 'data/hygiene'
image_exts = ['jpeg', 'jpg', 'bmp', 'png']

data = tf.keras.utils.image_dataset_from_directory('data/hygiene')
...
model_path = 'models/hygiene_class.h5'
...
if img is not None:
    ...
    plt.title(f"predicted bathroom item: {class_names[predicted_idx]} ({confidence*100:.1f}%)")
    plt.axis('off')
    plt.show()
