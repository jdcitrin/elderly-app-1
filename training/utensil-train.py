...
data_dir = 'data/utensils'
image_exts = ['jpeg', 'jpg', 'bmp', 'png']

data = tf.keras.utils.image_dataset_from_directory('data/utensils')
...
model_path = 'models/utensils_class.h5'
...
# Test individual utensil image
test_image_path = 'test/testpizzacutter.jpg'  # Use real path
...
if img is not None:
    ...
    plt.title(f"predicted utensil: {class_names[predicted_idx]} ({confidence*100:.1f}%)")
    plt.axis('off')
    plt.show()
